    ...
    render: (
      <div className="portfolio-item">
        ...
        <div className="portfolio-item__desc">
          <ul>
            <li>
              ● Created a common repository containing several docker images for
              various courses at NYU.
            </li>
            <li>
              ● Automated the devops pipeline using Travis CI. Decreased Travis
              build time by 50% using cache.
            </li>
          </ul>
        </div>
        <div className="portfolio-item__icon">
    ...
    render: (
      <div className="portfolio-item">
        ...
        <div className="portfolio-item__desc">
          <ul>
            <li>
              ● Music Streaming service built using Ethereum blockchain and AWS.
            </li>
            <li>
              ● Built a recommender system using AWS Sagemaker to help discover
              new songs
            </li>
          </ul>
        </div>
